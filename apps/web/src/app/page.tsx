      ...
      <div className={styles.col4}>
        <Card title="Financial Pulse" subtitle="Real-time margin & burn tracking">
          <div style={{ display: 'grid', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>Cost/Delivery</span>
              <span style={{ fontWeight: 700, fontSize: '1.1rem', color: 'var(--success)' }}>$0.85</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>Contribution Margin</span>
        ...
        <Card title="AI Forecast" subtitle="Predictive demand for next 4h">
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
             ...
             <div>
               <div style={{ fontSize: '1.25rem', fontWeight: 800 }}>+24% Surge</div>
      ...
      <div className={styles.col4}>
        <Card title="Customer Sentiment" subtitle="Live CSAT & Complaint tracking">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div className={styles.utilBar} style={{ height: '8px' }}>
      ...
      <div className={styles.col8}>
         <Card title="Operational Exceptions" subtitle="Critical alerts requiring attention">
           <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
             <div style={{ padding: '1rem', background: 'rgba(239, 68, 68, 0.1)', border: '1px solid rgba(239, 68, 68, 0.2)', borderRadius: '12px', display: 'flex', gap: '1rem', alignItems: 'center' }}>
             ...
             <div style={{ padding: '1rem', background: 'rgba(245, 158, 11, 0.1)', border: '1px solid rgba(245, 158, 11, 0.2)', borderRadius: '12px', display: 'flex', gap: '1rem', alignItems: 'center' }}>
